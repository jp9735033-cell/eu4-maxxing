...
NDiplomacy = {
	...
	MAX_ASKED_TRADE_POWER = 10,					-- Maximum % of someone's trade power can be asked for with the diplomatic action
	...
	CELESTIAL_EMPIRE_MANDATE_PER_STABILITY = 1.5,	-- Yearly change of Mandate for each point of positive stability
	...
	CELESTIAL_EMPIRE_MANDATE_PER_5_LOANS = -0,	-- Yearly change of Mandate for every 5 loans.
	...
	IMPERIAL_CITY_IA = 0.0075,						-- Monthly per imperial free city
...
NMilitary = {
	...
	GARRISON_SIZE = 2500, 							-- GARRISON_SIZE
...
NAI = {
	...
	UNCONDITIONAL_SURRENDER_WARSCORE_LIMIT = -75, -- AI won't surrender unless it's this bad.
	...
	ALLIANCE_DESIRE_TOO_MANY_RELATIONS = -70,				-- AI desire/acceptance for alliance when it has or will get too many relations. Multiplies with number of relations above limit.
	...
	MARRIAGE_DESIRE_TOO_MANY_RELATIONS = -70,				-- AI desire/acceptance for royal marriange when it has or will get too many relations. Multiplies with number of relations above limit.
	GUARANTEE_DESIRE_TOO_MANY_RELATIONS = -70,				-- AI desire for guaranteeing when it has or will get too many relations. Multiplies with number of relations above limit.
...
NNationDesigner = {
	...
	IDEAS_PERCENTAGE_LIMIT = 33,			-- Max % from any one category to not get overstacking penalty
